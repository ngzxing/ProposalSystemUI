...
import 'package:proposal_app/pages/Admin/AcademicProgramPage.dart';
import 'package:proposal_app/pages/Admin/LecturerPage.dart';
import 'package:proposal_app/pages/Admin/Profile.dart';
...
class _SidebarWithPagesState extends State<SidebarWithPages> {
  ...
  Widget _getPageByIndex(int index) {
    ...
    switch (index) {
      case 0:
        return const AcademicProgramPage();
      case 1:
  ...
  String _getTitleIndex(int index) {
    switch (index) {
      case 0:
        return "Acdemic Programs / Assign Committees ";
      case 1:
