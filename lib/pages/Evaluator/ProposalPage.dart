...
import 'package:proposal_app/pages/Evaluator/ProposalDetailPage.dart';
...
class _ProposalPageState extends State<ProposalPage> {
  ...
  void _showProposalDetails(SimpleListData data) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ProposalDetailPage(proposalId: data.id, parentKey: parentKey,),
      ),
    );
  }
}